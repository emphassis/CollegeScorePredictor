...
{
    public class ActionBetService
    {
        private IDbContextFactory<AppDbContext> factory;
        public ActionBetService(IDbContextFactory<AppDbContext> _factory)
        {
            factory = _factory;
        }
            ...
            using (var db = await factory.CreateDbContextAsync())
            {
                ...
                foreach (var odd in odds.games)
                {
                    ...
                    if (!noSpread)
                    {
                        ...
                        //    if ((didLoseBeforeHome + didLoseBeforeAway) > 1)
                        //    {
                        //        betGame = false;
                        //    }
                        //}
                        ...
                        #region Rule 8
                        //if the bet is for a team to win that isn't the team picked by the score and the win probability, don't bet
                        if (betAwaySpread)
                        {
                            if ((gameScores.First().AwayTeamWins - .2) < gameScores.First().HomeTeamWins)
                            {
                                betGame = false;
                                continue;
                            }
                        ...
                        if (betHomeSpread)
                        {
                            if ((gameScores.First().HomeTeamWins - .2) < gameScores.First().AwayTeamWins)
                            {
                                betGame = false;
                                continue;
                            }
                        ...
                        if (betAwayMoneyline)
                        {
                            if ((gameScores.First().AwayTeamWins) < gameScores.First().HomeTeamWins)
                            {
                                betGame = false;
                                continue;
                            }
                        ...
                        if (betHomeMoneyline)
                        {
                            if ((gameScores.First().HomeTeamWins) < gameScores.First().AwayTeamWins)
                            {
                                betGame = false;
                                continue;
                            }
                    ...
                    if (betHomeSpread)
                    {
                        ...
                        //odds 23-8 for 2021-2022
                        if (variance > 9)
                        {
                            betGame = false;
                        }

                        //only grabbing the winning most variances
                        //if (variance != 0 && variance != 1 && variance != 2 && variance != 4 && variance != 5 && variance != 7 && variance != 9)
                        //{
                        //    betGame = false;
                        //}
                        ...
                        await db.Bet.AddAsync(bet);
                    }
                    if (betAwaySpread)
                    {
                        //specific to this model
                        //odds 31-11 for 2021-2022
                        if (variance > 7)
                        {
                            betGame = false;
                        }
                        ...
                        //only grabbing the winning most variances
                        //if (variance != 0 && variance != 3 && variance != 4 && variance != 6 && variance != 7)
                        //{
                        //    betGame = false;
                        //}
                    ...
                    if (betHomeMoneyline)
                    {
                        ...
                        //only grabbing the winning most variances
                        //if (variance != 0 && variance != 1 && variance != 2 && variance != 3 && variance != 4 && variance != 6 && variance != 7 && variance != 8 && variance != 9 && variance != 10 && variance != 11)
                        //{
                        //    betGame = false;
                        //}
                    ...
                    {
                        //specific to this model
                        //odds suck through and through on this
                        ...
                        //only grabbing the winning most variances
                        //if (variance != 3 && variance != 5 && variance != 9 && variance != 10 && variance != 11 && variance != 12)
                        //{
                        //    betGame = false;
                        //}
                    ...
                    if (betOver)
                    {
                        ...
                        //only grabbing the winning most variances
                        //if (variance != 0 && variance != 2 && variance != 3 && variance != 6 && variance != 7)
                        //{
                        //    betGame = false;
                        //}
                    ...
                    if (betUnder)
                    {
                        ...
                        //only grabbing the winning most variances
                        //if (variance != 1 && variance != 2 && variance != 3 && variance != 4 && variance != 6 && variance != 7 && variance != 9)
                        //{
                        //    betGame = false;
                        //}
